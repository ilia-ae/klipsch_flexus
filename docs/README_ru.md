...
> ✅ **Актуально на v2.5.10 (2026-06-13)** — **41 сущность**, все команды записи проверены вживую на прошивке 2026 (HMAC-подпись), управляемы в standby. Бейджи выше отражают актуальный релиз и последний push.
