...
> ✅ **Актуально на v2.5.15 (2026-06-14)** — **41 сущность**, все команды записи проверены вживую на прошивке 2026 (HMAC-подпись), управляемы в standby. Бейджи выше отражают актуальный релиз и последний push.
